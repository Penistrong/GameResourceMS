	...
	<div id="adCarousel" class="carousel slide col-md-8 col-md-offset-2">
		...
		<div class="carousel-inner">
			<div class="item active">
				<img alt="广告" class="ads-image"
					src="http://upload.ouliu.net/i/201710200835097sxf8.jpeg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<img alt="广告" class="ads-image"
					src="http://upload.ouliu.net/i/201710200848121eydw.jpeg">
				<div class="carousel-caption"></div>
			</div>
			<div class="item">
				<!-- <img alt="广告" src="<%=image_path%>/resource/image/ads"> -->
				<img alt="广告" class="ads-image"
					src="http://upload.ouliu.net/i/20171020082737gu189.jpeg">
				<div class="carousel-caption"></div>
			</div>
		</div>
		<!-- 轮播导航 -->
		<a class="left carousel-control" href="#adCarousel" role="button"
			data-slide="prev"> <span class="glyphicon glyphicon-chevron-left"
			aria-hidden="true"></span> <span class="sr-only">Previous</span>
		</a> <a class="right carousel-control" href="#adCarousel" role="button"
